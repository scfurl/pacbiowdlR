...
fusions <- get_fusions_from_vcf(a4573$humanwgs_singleton.phased_sv_vcf, gtf_file = gtf, plot = T, annotate = T, thresh = 20)

fusions<-get_fusions_from_vcf(a4573$humanwgs_singleton.phased_sv_vcf, plot = T, thresh = 20, highlight = 1, title = "A4573")
