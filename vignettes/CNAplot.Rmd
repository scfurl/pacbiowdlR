...
```{r, include = F, eval=F}
library(pacbiowdlR)
a673 <- read_json_file("/Volumes/furlan_s/sfurlan/250711_lewings_lines/pacbiowdlR/A673/outputs.json", sub1 = "/fh/working")
pdx305 <- read_json_file("/Volumes/furlan_s/sfurlan/250711_lewings_lines/pacbiowdlR/PDX305/outputs.json", sub1 = "/fh/working")
chla10 <- read_json_file("/Volumes/furlan_s/sfurlan/250711_lewings_lines/pacbiowdlR/CHLA10/outputs.json", sub1 = "/fh/working")
chla9 <- read_json_file("/Volumes/furlan_s/sfurlan/250711_lewings_lines/pacbiowdlR/CHLA9/outputs.json", sub1 = "/fh/working")
tc71 <- read_json_file("/Volumes/furlan_s/sfurlan/250711_lewings_lines/pacbiowdlR/TC71/outputs.json", sub1 = "/fh/working")
tc32 <- read_json_file("/Volumes/furlan_s/sfurlan/250711_lewings_lines/pacbiowdlR/TC32/outputs.json", sub1 = "/fh/working")
rdes <- read_json_file("/Volumes/furlan_s/sfurlan/250711_lewings_lines/pacbiowdlR/RDES/outputs.json", sub1 = "/fh/working")
sknmc <- read_json_file("/Volumes/furlan_s/sfurlan/250711_lewings_lines/pacbiowdlR/SKNMC/outputs.json", sub1 = "/fh/working")
a4573 <- read_json_file("/Volumes/furlan_s/sfurlan/250711_lewings_lines/pacbiowdlR/A4573/outputs.json", sub1 = "/fh/working")
...
a673$humanwgs_singleton.stat_mean_depth
CNA_plot(depth_bigwig_file  =   a673$humanwgs_singleton.cnv_depth_bw, trend_regions = "inside",
  variant_file       =   a673$humanwgs_singleton.cnv_vcf, 
  downsample         = 0.1,  method = "fit", min_value = -3, max_value = 3, colors = chrom_palette,
  samplename         = "a673", line_color = "black")

CNA_plot_highlight(depth_bigwig_file  =   a673$humanwgs_singleton.cnv_depth_bw, downsample = 1,
                  variant_file       =   a673$humanwgs_singleton.cnv_vcf, max_value = 3, min_value = -3,
                  method = "fit", line_color = "black", chr_filter = "chr9", highlight_genes = "CDKN2A",
                  colors = chrom_palette, txdb = TxDb.Hsapiens.UCSC.hg38.knownGene::TxDb.Hsapiens.UCSC.hg38.knownGene, 
                  org = org.Hs.eg.db::org.Hs.eg.db, samplename = "a673")


pdx305$humanwgs_singleton.stat_mean_depth
CNA_plot(depth_bigwig_file  =   pdx305$humanwgs_singleton.cnv_depth_bw, trend_regions = "inside",
  variant_file       =   pdx305$humanwgs_singleton.cnv_vcf, 
  downsample         = 0.1,  method = "fit", min_value = -3, max_value = 3, colors = chrom_palette,
  samplename         = "pdx305", line_color = "black")

CNA_plot_highlight(depth_bigwig_file  =   pdx305$humanwgs_singleton.cnv_depth_bw, downsample = 1,
                  variant_file       =   pdx305$humanwgs_singleton.cnv_vcf, max_value = 3, min_value = -3,
                  method = "fit", line_color = "black", chr_filter = "chr9", highlight_genes = "CDKN2A",
                  colors = chrom_palette, txdb = TxDb.Hsapiens.UCSC.hg38.knownGene::TxDb.Hsapiens.UCSC.hg38.knownGene, 
                  org = org.Hs.eg.db::org.Hs.eg.db, samplename = "pdx305")
```
