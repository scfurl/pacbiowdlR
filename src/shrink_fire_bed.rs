...
#[derive(Parser, Debug)]
#[command(name = "shrink_fire_bed")]
#[command(version = "0.1")]
#[command(about = "Shrinks pileup bed files emanating from the FIRE pipeline", long_about = "Merges adjacent -1.0 intervals in a Tabix-indexed BED file into a single interval. This is useful for reducing the size of pileup files generated by the FIRE pipeline.")]
struct Args {
