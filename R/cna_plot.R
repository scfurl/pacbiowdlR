...
#' @param downsample Numeric. Proportion of coverage data to retain (e.g., 0.01 for 1%).
...
#' \enumerate{
#'   \item Imports coverage data from the BigWig file using \code{import.bw()} and keeps only standard chromosomes
#'         (with \code{keepStandardChromosomes()}).
...
#' @importFrom ggplot2 ggplot geom_point geom_line scale_color_manual scale_fill_manual geom_vline labs theme_minimal theme guides scale_y_continuous scale_x_continuous element_text element_blank
